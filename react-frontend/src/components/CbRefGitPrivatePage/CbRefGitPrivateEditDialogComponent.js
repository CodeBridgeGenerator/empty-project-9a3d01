...
value: _entity?.value,
        ...
        const result = await client.service("cbRefGitPrivate").patch(_entity._id, _data);
        props.onHide();
        props.alert({ type: "success", title: "Edit info", message: "Info cbRefGitPrivate updated successfully" });
    ...
    return (
        <Dialog header="Edit Cb Ref Git Private" visible={props.show} closable={false} onHide={props.onHide} modal style={{ width: "40vw" }} className="min-w-max" footer={renderFooter()} resizable={false}>
            <div className="grid p-fluid overflow-y-auto"
            style={{ maxWidth: "55vw" }} role="cbRefGitPrivate-edit-dialog-component">
