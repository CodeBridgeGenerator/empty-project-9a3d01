...
image: _entity?.image,
        ...
        const result = await client.service("cbRefSupport").patch(_entity._id, _data);
        props.onHide();
        props.alert({ type: "success", title: "Edit info", message: "Info cbRefSupport updated successfully" });
    ...
    return (
        <Dialog header="Edit Cb Ref Support" visible={props.show} closable={false} onHide={props.onHide} modal style={{ width: "40vw" }} className="min-w-max" footer={renderFooter()} resizable={false}>
            <div className="grid p-fluid overflow-y-auto"
            style={{ maxWidth: "55vw" }} role="cbRefSupport-edit-dialog-component">
