...
import CbRefPackagesPage from "../CbRefPackagesPage/CbRefPackagesPage";
import CbRefHostingPage from "../CbRefHostingPage/CbRefHostingPage";
import CbRefSupportPage from "../CbRefSupportPage/CbRefSupportPage";
import CbRefDomainsPage from "../CbRefDomainsPage/CbRefDomainsPage";
import CbRefDiscountCodePage from "../CbRefDiscountCodePage/CbRefDiscountCodePage";
import CbRefGitPrivatePage from "../CbRefGitPrivatePage/CbRefGitPrivatePage";
import AddonDiscountPage from "../AddonDiscountPage/AddonDiscountPage";
import AddonPackagePage from "../AddonPackagePage/AddonPackagePage";
import AddonHostingPage from "../AddonHostingPage/AddonHostingPage";
import AddonDomainPage from "../AddonDomainPage/AddonDomainPage";
import AddonPrivacyPage from "../AddonPrivacyPage/AddonPrivacyPage";
import AddonUsersPage from "../AddonUsersPage/AddonUsersPage";
import ProjectsPage from "../ProjectsPage/ProjectsPage";
import AddonSupportPage from "../AddonSupportPage/AddonSupportPage";
// ~cb-add-import~
...
case "cbRefPackages":
                return <CbRefPackagesPage />;
case "cbRefHosting":
                return <CbRefHostingPage />;
case "cbRefSupport":
                return <CbRefSupportPage />;
case "cbRefDomains":
                return <CbRefDomainsPage />;
case "cbRefDiscountCode":
                return <CbRefDiscountCodePage />;
case "cbRefGitPrivate":
                return <CbRefGitPrivatePage />;
case "addonDiscount":
                return <AddonDiscountPage />;
case "addonPackage":
                return <AddonPackagePage />;
case "addonHosting":
                return <AddonHostingPage />;
case "addonDomain":
                return <AddonDomainPage />;
case "addonPrivacy":
                return <AddonPrivacyPage />;
case "addonUsers":
                return <AddonUsersPage />;
case "projects":
                return <ProjectsPage />;
case "addonSupport":
                return <AddonSupportPage />;
      /* ~cb-add-thurthy~ */
      default:
...
<li
                onClick={() => {
                  setCurrentActiveTab2("cbRefPackages");
                }}
                className={classNames("mb-3 flex align-items-start p-3", {
                  "bg-yellow-700": props?.currentActiveTab2 === "cbRefPackages",
                })}
                style={{ borderRadius: "12px" }}
              >
                <i
                  className="pi pi-user text-xl mr-3 "
                  style={{ color: props?.currentActiveTab2 !== "cbRefPackages" ? "black" : "white" }}
                ></i>
                <div className="flex flex-column">
                  <span
                    className={classNames({
                      "text-white": props?.currentActiveTab2 === "cbRefPackages",
                      "text-black": props?.currentActiveTab2 !== "cbRefPackages",
                    })}
                  >
                  Cb Ref Packages
                  </span>
                  <p
                    className={classNames("mt-2 mb-0 line-height-3 ", {
                      "text-yellow-500": props?.currentActiveTab2 === "cbRefPackages",
                      "text-yellow-700": props?.currentActiveTab2 !== "cbRefPackages",
                    })}
                  >
...
<li
                onClick={() => {
                  setCurrentActiveTab2("cbRefHosting");
                }}
                className={classNames("mb-3 flex align-items-start p-3", {
                  "bg-yellow-700": props?.currentActiveTab2 === "cbRefHosting",
                })}
                style={{ borderRadius: "12px" }}
              >
                <i
                  className="pi pi-user text-xl mr-3 "
                  style={{ color: props?.currentActiveTab2 !== "cbRefHosting" ? "black" : "white" }}
                ></i>
                <div className="flex flex-column">
                  <span
                    className={classNames({
                      "text-white": props?.currentActiveTab2 === "cbRefHosting",
                      "text-black": props?.currentActiveTab2 !== "cbRefHosting",
                    })}
                  >
                  Cb Ref Hosting
                  </span>
                  <p
                    className={classNames("mt-2 mb-0 line-height-3 ", {
                      "text-yellow-500": props?.currentActiveTab2 === "cbRefHosting",
                      "text-yellow-700": props?.currentActiveTab2 !== "cbRefHosting",
                    })}
                  >
                    Accumsan sit amet nulla facilisi morbi tempus iaculis.
                  </p>
...
<li
                onClick={() => {
                  setCurrentActiveTab2("cbRefSupport");
                }}
                className={classNames("mb-3 flex align-items-start p-3", {
                  "bg-yellow-700": props?.currentActiveTab2 === "cbRefSupport",
                })}
                style={{ borderRadius: "12px" }}
              >
                <i
                  className="pi pi-user text-xl mr-3 "
                  style={{ color: props?.currentActiveTab2 !== "cbRefSupport" ? "black" : "white" }}
                ></i>
                <div className="flex flex-column">
                  <span
                    className={classNames({
                      "text-white": props?.currentActiveTab2 === "cbRefSupport",
                      "text-black": props?.currentActiveTab2 !== "cbRefSupport",
                    })}
                  >
                  Cb Ref Support
                  </span>
                  <p
                    className={classNames("mt-2 mb-0 line-height-3 ", {
                      "text-yellow-500": props?.currentActiveTab2 === "cbRefSupport",
                      "text-yellow-700": props?.currentActiveTab2 !== "cbRefSupport",
                    })}
                  >
                    Accumsan sit amet nulla facilisi morbi tempus iaculis.
                  </p>
...
<li
                onClick={() => {
                  setCurrentActiveTab2("cbRefDomains");
                }}
                className={classNames("mb-3 flex align-items-start p-3", {
                  "bg-yellow-700": props?.currentActiveTab2 === "cbRefDomains",
                })}
                style={{ borderRadius: "12px" }}
              >
                <i
                  className="pi pi-user text-xl mr-3 "
                  style={{ color: props?.currentActiveTab2 !== "cbRefDomains" ? "black" : "white" }}
                ></i>
                <div className="flex flex-column">
                  <span
                    className={classNames({
                      "text-white": props?.currentActiveTab2 === "cbRefDomains",
                      "text-black": props?.currentActiveTab2 !== "cbRefDomains",
                    })}
                  >
                  Cb Ref Domains
                  </span>
                  <p
                    className={classNames("mt-2 mb-0 line-height-3 ", {
                      "text-yellow-500": props?.currentActiveTab2 === "cbRefDomains",
                      "text-yellow-700": props?.currentActiveTab2 !== "cbRefDomains",
                    })}
                  >
                    Accumsan sit amet nulla facilisi morbi tempus iaculis.
                  </p>
...
<li
                onClick={() => {
                  setCurrentActiveTab2("cbRefDiscountCode");
                }}
                className={classNames("mb-3 flex align-items-start p-3", {
                  "bg-yellow-700": props?.currentActiveTab2 === "cbRefDiscountCode",
                })}
                style={{ borderRadius: "12px" }}
              >
                <i
                  className="pi pi-user text-xl mr-3 "
                  style={{ color: props?.currentActiveTab2 !== "cbRefDiscountCode" ? "black" : "white" }}
                ></i>
                <div className="flex flex-column">
                  <span
                    className={classNames({
                      "text-white": props?.currentActiveTab2 === "cbRefDiscountCode",
                      "text-black": props?.currentActiveTab2 !== "cbRefDiscountCode",
                    })}
                  >
                  Cb Ref Discount Code
                  </span>
                  <p
                    className={classNames("mt-2 mb-0 line-height-3 ", {
                      "text-yellow-500": props?.currentActiveTab2 === "cbRefDiscountCode",
                      "text-yellow-700": props?.currentActiveTab2 !== "cbRefDiscountCode",
                    })}
                  >
                    Accumsan sit amet nulla facilisi morbi tempus iaculis.
                  </p>
...
<li
                onClick={() => {
                  setCurrentActiveTab2("cbRefGitPrivate");
                }}
                className={classNames("mb-3 flex align-items-start p-3", {
                  "bg-yellow-700": props?.currentActiveTab2 === "cbRefGitPrivate",
                })}
                style={{ borderRadius: "12px" }}
              >
                <i
                  className="pi pi-user text-xl mr-3 "
                  style={{ color: props?.currentActiveTab2 !== "cbRefGitPrivate" ? "black" : "white" }}
                ></i>
                <div className="flex flex-column">
                  <span
                    className={classNames({
                      "text-white": props?.currentActiveTab2 === "cbRefGitPrivate",
                      "text-black": props?.currentActiveTab2 !== "cbRefGitPrivate",
                    })}
                  >
                  Cb Ref Git Private
                  </span>
                  <p
                    className={classNames("mt-2 mb-0 line-height-3 ", {
                      "text-yellow-500": props?.currentActiveTab2 === "cbRefGitPrivate",
                      "text-yellow-700": props?.currentActiveTab2 !== "cbRefGitPrivate",
                    })}
                  >
                    Accumsan sit amet nulla facilisi morbi tempus iaculis.
                  </p>
...
<li
                onClick={() => {
                  setCurrentActiveTab2("addonDiscount");
                }}
                className={classNames("mb-3 flex align-items-start p-3", {
                  "bg-yellow-700": props?.currentActiveTab2 === "addonDiscount",
                })}
                style={{ borderRadius: "12px" }}
              >
                <i
                  className="pi pi-user text-xl mr-3 "
                  style={{ color: props?.currentActiveTab2 !== "addonDiscount" ? "black" : "white" }}
                ></i>
                <div className="flex flex-column">
                  <span
                    className={classNames({
                      "text-white": props?.currentActiveTab2 === "addonDiscount",
                      "text-black": props?.currentActiveTab2 !== "addonDiscount",
                    })}
                  >
                  Addon Discount
                  </span>
                  <p
                    className={classNames("mt-2 mb-0 line-height-3 ", {
                      "text-yellow-500": props?.currentActiveTab2 === "addonDiscount",
                      "text-yellow-700": props?.currentActiveTab2 !== "addonDiscount",
                    })}
                  >
                    Accumsan sit amet nulla facilisi morbi tempus iaculis.
                  </p>
...
<li
                onClick={() => {
                  setCurrentActiveTab2("addonPackage");
                }}
                className={classNames("mb-3 flex align-items-start p-3", {
                  "bg-yellow-700": props?.currentActiveTab2 === "addonPackage",
                })}
                style={{ borderRadius: "12px" }}
              >
                <i
                  className="pi pi-user text-xl mr-3 "
                  style={{ color: props?.currentActiveTab2 !== "addonPackage" ? "black" : "white" }}
                ></i>
                <div className="flex flex-column">
                  <span
                    className={classNames({
                      "text-white": props?.currentActiveTab2 === "addonPackage",
                      "text-black": props?.currentActiveTab2 !== "addonPackage",
                    })}
                  >
                  Addon Package
                  </span>
                  <p
                    className={classNames("mt-2 mb-0 line-height-3 ", {
                      "text-yellow-500": props?.currentActiveTab2 === "addonPackage",
                      "text-yellow-700": props?.currentActiveTab2 !== "addonPackage",
                    })}
                  >
                    Accumsan sit amet nulla facilisi morbi tempus iaculis.
                  </p>
...
<li
                onClick={() => {
                  setCurrentActiveTab2("addonHosting");
                }}
                className={classNames("mb-3 flex align-items-start p-3", {
                  "bg-yellow-700": props?.currentActiveTab2 === "addonHosting",
                })}
                style={{ borderRadius: "12px" }}
              >
                <i
                  className="pi pi-user text-xl mr-3 "
                  style={{ color: props?.currentActiveTab2 !== "addonHosting" ? "black" : "white" }}
                ></i>
                <div className="flex flex-column">
                  <span
                    className={classNames({
                      "text-white": props?.currentActiveTab2 === "addonHosting",
                      "text-black": props?.currentActiveTab2 !== "addonHosting",
                    })}
                  >
                  Addon Hosting
                  </span>
                  <p
                    className={classNames("mt-2 mb-0 line-height-3 ", {
                      "text-yellow-500": props?.currentActiveTab2 === "addonHosting",
                      "text-yellow-700": props?.currentActiveTab2 !== "addonHosting",
                    })}
                  >
                    Accumsan sit amet nulla facilisi morbi tempus iaculis.
                  </p>
...
<li
                onClick={() => {
                  setCurrentActiveTab2("addonDomain");
                }}
                className={classNames("mb-3 flex align-items-start p-3", {
                  "bg-yellow-700": props?.currentActiveTab2 === "addonDomain",
                })}
                style={{ borderRadius: "12px" }}
              >
                <i
                  className="pi pi-user text-xl mr-3 "
                  style={{ color: props?.currentActiveTab2 !== "addonDomain" ? "black" : "white" }}
                ></i>
                <div className="flex flex-column">
                  <span
                    className={classNames({
                      "text-white": props?.currentActiveTab2 === "addonDomain",
                      "text-black": props?.currentActiveTab2 !== "addonDomain",
                    })}
                  >
                  Addon Domain
                  </span>
                  <p
                    className={classNames("mt-2 mb-0 line-height-3 ", {
                      "text-yellow-500": props?.currentActiveTab2 === "addonDomain",
                      "text-yellow-700": props?.currentActiveTab2 !== "addonDomain",
                    })}
                  >
                    Accumsan sit amet nulla facilisi morbi tempus iaculis.
                  </p>
...
<li
                onClick={() => {
                  setCurrentActiveTab2("addonPrivacy");
                }}
                className={classNames("mb-3 flex align-items-start p-3", {
                  "bg-yellow-700": props?.currentActiveTab2 === "addonPrivacy",
                })}
                style={{ borderRadius: "12px" }}
              >
                <i
                  className="pi pi-user text-xl mr-3 "
                  style={{ color: props?.currentActiveTab2 !== "addonPrivacy" ? "black" : "white" }}
                ></i>
                <div className="flex flex-column">
                  <span
                    className={classNames({
                      "text-white": props?.currentActiveTab2 === "addonPrivacy",
                      "text-black": props?.currentActiveTab2 !== "addonPrivacy",
                    })}
                  >
                  Addon Privacy
                  </span>
                  <p
                    className={classNames("mt-2 mb-0 line-height-3 ", {
                      "text-yellow-500": props?.currentActiveTab2 === "addonPrivacy",
                      "text-yellow-700": props?.currentActiveTab2 !== "addonPrivacy",
                    })}
                  >
                    Accumsan sit amet nulla facilisi morbi tempus iaculis.
                  </p>
...
<li
                onClick={() => {
                  setCurrentActiveTab2("addonUsers");
                }}
                className={classNames("mb-3 flex align-items-start p-3", {
                  "bg-yellow-700": props?.currentActiveTab2 === "addonUsers",
                })}
                style={{ borderRadius: "12px" }}
              >
                <i
                  className="pi pi-user text-xl mr-3 "
                  style={{ color: props?.currentActiveTab2 !== "addonUsers" ? "black" : "white" }}
                ></i>
                <div className="flex flex-column">
                  <span
                    className={classNames({
                      "text-white": props?.currentActiveTab2 === "addonUsers",
                      "text-black": props?.currentActiveTab2 !== "addonUsers",
                    })}
                  >
                  Addon Users
                  </span>
                  <p
                    className={classNames("mt-2 mb-0 line-height-3 ", {
                      "text-yellow-500": props?.currentActiveTab2 === "addonUsers",
                      "text-yellow-700": props?.currentActiveTab2 !== "addonUsers",
                    })}
                  >
                    Accumsan sit amet nulla facilisi morbi tempus iaculis.
                  </p>
...
<li
                onClick={() => {
                  setCurrentActiveTab2("addonSupport");
                }}
                className={classNames("mb-3 flex align-items-start p-3", {
                  "bg-yellow-700": props?.currentActiveTab2 === "addonSupport",
                })}
                style={{ borderRadius: "12px" }}
              >
                <i
                  className="pi pi-user text-xl mr-3 "
                  style={{ color: props?.currentActiveTab2 !== "addonSupport" ? "black" : "white" }}
                ></i>
                <div className="flex flex-column">
                  <span
                    className={classNames({
                      "text-white": props?.currentActiveTab2 === "addonSupport",
                      "text-black": props?.currentActiveTab2 !== "addonSupport",
                    })}
                  >
                  Addon Support
                  </span>
                  <p
                    className={classNames("mt-2 mb-0 line-height-3 ", {
                      "text-yellow-500": props?.currentActiveTab2 === "addonSupport",
                      "text-yellow-700": props?.currentActiveTab2 !== "addonSupport",
                    })}
                  >
                    Accumsan sit amet nulla facilisi morbi tempus iaculis.
                  </p>
